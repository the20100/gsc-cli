...
// update self-updates the gsc binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/gsc-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update gsc to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "gsc-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "gsc")
